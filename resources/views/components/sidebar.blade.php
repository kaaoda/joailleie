<div class="main-sidebar sidebar-style-2 d-print-none">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            {{-- <li><a class="nav-link" href="blank.html"><i data-feather="file-text"></i><span>Invoices</span></a></li> --}}
            <li><a class="nav-link" href="blank.html"><i data-feather="refresh-cw"></i><span>Returns & Exchanges</span></a></li>
            ...
            <li><a class="nav-link" href="blank.html"><i data-feather="gift"></i><span>Special Requests</span></a></li>
            <li><a class="nav-link" href="blank.html"><i data-feather="activity"></i><span>Maintenance Requests</span></a></li>
            ...
            <li><a class="nav-link" href="timeline.html"><i data-feather="settings"></i><span>Settings</span></a></li>
        </ul>
    </aside>
</div>
